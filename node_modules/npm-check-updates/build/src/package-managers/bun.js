...
exports.patch = exports.minor = exports.semver = exports.newest = exports.latest = exports.greatest = exports.list = exports.defaultPrefix = void 0;
...
const defaultPrefix = async (options) => {
    if (options.prefix) {
    ...
    const bin = await (0, spawn_please_1.default)('bun', ['pm', '-g', 'bin']);
    return path_1.default.dirname(bin);
};
