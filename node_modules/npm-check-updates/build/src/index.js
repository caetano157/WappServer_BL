...
async function run(runOptions = {}, { cli } = {}) {
    ...
    if (!options.prefix) {
        const defaultPrefix = ((_a = package_managers_1.default[options.packageManager || '']) === null || _a === void 0 ? void 0 : _a.defaultPrefix) || package_managers_1.default.npm.defaultPrefix;
